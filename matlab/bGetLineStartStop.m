function [startColumn,endColumn, pntsPerLine, numLines] = bGetLineStartStop(tifPath)
    ...
    numLines = int16(numLines);
    pntsPerLine = int16(pntsPerLine);
    ...
    showThisNumberOfLines = 500;
    % abb nov2022, inverted logic
    ...
    % abb nov 2022, cast to uint16
%     startColumn = int16(startColumn);
%     endColumn = int16(endColumn);
